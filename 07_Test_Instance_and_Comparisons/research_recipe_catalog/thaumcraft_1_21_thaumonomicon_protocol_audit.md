...
| `index_revision_matches_server_state` | `PASS` | revision=-1417310236 |
...
| `ready_arcane_catalog_entries_have_valid_server_snapshots` | `PASS` | ready_arcane_entries=14 |
...
| `client_cache_stores_authoritative_revision` | `PASS` | revision=-1417310236 |
