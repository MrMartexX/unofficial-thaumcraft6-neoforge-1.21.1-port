...
| `index_revision_matches_server_state` | `PASS` | revision=1285133438 |
...
| `ready_crafting_catalog_entries_have_valid_server_snapshots` | `PASS` | ready_crafting_entries=5 |
| `ready_arcane_catalog_entries_have_valid_server_snapshots` | `PASS` | ready_arcane_entries=2 |
...
| `client_cache_stores_authoritative_revision` | `PASS` | revision=1285133438 |
