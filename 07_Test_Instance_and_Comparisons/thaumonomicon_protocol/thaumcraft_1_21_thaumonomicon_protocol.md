...
| `index_revision_matches_server_state` | `PASS` | revision=920579701 |
...
| `ready_arcane_catalog_entries_have_valid_server_snapshots` | `PASS` | ready_arcane_entries=5 |
...
| `client_cache_stores_authoritative_revision` | `PASS` | revision=920579701 |
