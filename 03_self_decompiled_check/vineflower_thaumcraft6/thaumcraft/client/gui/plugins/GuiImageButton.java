...
public class GuiImageButton extends GuiButton {
   ...
   public void func_191745_a(Minecraft mc, int xx, int yy, float pt) {
      if (this.field_146125_m) {
         ...
         if (this.field_146126_j != null) {
            ...
            GL11.glPushMatrix();
            GL11.glTranslated(this.field_146128_h, this.field_146129_i, 0.0);
   ...
   public boolean func_146116_c(Minecraft mc, int mouseX, int mouseY) {
      return this.active
         && this.field_146124_l
         && this.field_146125_m
         && mouseX >= this.field_146128_h - this.field_146120_f / 2
         && mouseY >= this.field_146129_i - this.field_146121_g / 2
         && mouseX < this.field_146128_h - this.field_146120_f / 2 + this.field_146120_f
         && mouseY < this.field_146129_i - this.field_146121_g / 2 + this.field_146121_g;
   }
}
