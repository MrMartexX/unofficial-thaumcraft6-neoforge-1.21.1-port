...
public class TileInfusionMatrixRenderer extends TileEntitySpecialRenderer<TileInfusionMatrix> {
   ...
   private void drawHalo(TileEntity is, double x, double y, double z, float par8, int count) {
      ...
      for (int i = 0; i < q; i++) {
         ...
         tessellator.func_178180_c().func_181662_b(-0.866 * f4, fa, -0.5F * f4).func_181669_b(255, 0, 255, 0).func_181675_d();
         tessellator.func_178180_c().func_181662_b(0.866 * f4, fa, -0.5F * f4).func_181669_b(255, 0, 255, 0).func_181675_d();
         tessellator.func_178180_c().func_181662_b(0.0, fa, 1.0F * f4).func_181669_b(255, 0, 255, 0).func_181675_d();
         tessellator.func_178180_c().func_181662_b(-0.866 * f4, fa, -0.5F * f4).func_181669_b(255, 0, 255, 0).func_181675_d();
   ...
   public void renderInfusionMatrix(TileInfusionMatrix is, double par2, double par4, double par6, float par8, int destroyStage) {
      ...
      for (int a = 0; a < 2; a++) {
         for (int b = 0; b < 2; b++) {
            for (int c = 0; c < 2; c++) {
               if (active) {
                  b1 = MathHelper.func_76126_a((ticks + a * 10) / 15.0F) * 0.01F * startup * instability;
                  b2 = MathHelper.func_76126_a((ticks + b * 10) / 14.0F) * 0.01F * startup * instability;
                  b3 = MathHelper.func_76126_a((ticks + c * 10) / 13.0F) * 0.01F * startup * instability;
               }
         ...
         for (int a = 0; a < 2; a++) {
            for (int b = 0; b < 2; b++) {
               for (int c = 0; c < 2; c++) {
                  ...
                  GL11.glColor4f(0.8F, 0.1F, 1.0F, (MathHelper.func_76126_a((ticks + a * 2 + b * 3 + c * 4) / 4.0F) * 0.1F + 0.2F) * startup);
