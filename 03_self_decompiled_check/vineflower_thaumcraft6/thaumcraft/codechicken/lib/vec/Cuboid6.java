...
public class Cuboid6 implements Copyable<Cuboid6> {
   ...
   public boolean intersects(Cuboid6 b) {
      return this.max.x - 1.0E-5 > b.min.x
         && b.max.x - 1.0E-5 > this.min.x
         && this.max.y - 1.0E-5 > b.min.y
         && b.max.y - 1.0E-5 > this.min.y
         && this.max.z - 1.0E-5 > b.min.z
         && b.max.z - 1.0E-5 > this.min.z;
   }
   ...
   public String toString() {
      ...
      return "Cuboid: ("
         + new BigDecimal(this.min.x, cont)
         + ", "
         + new BigDecimal(this.min.y, cont)
         + ", "
         + new BigDecimal(this.min.z, cont)
         + ") -> ("
         + new BigDecimal(this.max.x, cont)
         + ", "
         + new BigDecimal(this.max.y, cont)
         + ", "
         + new BigDecimal(this.max.z, cont)
         + ")";
   }
