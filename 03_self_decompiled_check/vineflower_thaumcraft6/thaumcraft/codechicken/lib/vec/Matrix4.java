...
public class Matrix4 extends Transformation implements Copyable<Matrix4> {
   ...
   public Matrix4 translate(Vector3 vec) {
      this.m03 = this.m03 + (this.m00 * vec.x + this.m01 * vec.y + this.m02 * vec.z);
      this.m13 = this.m13 + (this.m10 * vec.x + this.m11 * vec.y + this.m12 * vec.z);
      this.m23 = this.m23 + (this.m20 * vec.x + this.m21 * vec.y + this.m22 * vec.z);
      this.m33 = this.m33 + (this.m30 * vec.x + this.m31 * vec.y + this.m32 * vec.z);
      return this;
   }

   public Matrix4 scale(Vector3 vec) {
      this.m00 = this.m00 * vec.x;
      this.m10 = this.m10 * vec.x;
      this.m20 = this.m20 * vec.x;
      this.m30 = this.m30 * vec.x;
      this.m01 = this.m01 * vec.y;
      this.m11 = this.m11 * vec.y;
      this.m21 = this.m21 * vec.y;
      this.m31 = this.m31 * vec.y;
      this.m02 = this.m02 * vec.z;
      this.m12 = this.m12 * vec.z;
      this.m22 = this.m22 * vec.z;
      this.m32 = this.m32 * vec.z;
      return this;
   }
