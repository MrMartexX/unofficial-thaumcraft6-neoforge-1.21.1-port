...
public class BlockPlantVishroom extends BlockBush {
   ...
   public void func_180655_c(IBlockState state, World world, BlockPos pos, Random rand) {
      if (rand.nextInt(3) == 0) {
         float xr = pos.func_177958_n() + 0.5F + (rand.nextFloat() - rand.nextFloat()) * 0.4F;
         float yr = pos.func_177956_o() + 0.3F;
         float zr = pos.func_177952_p() + 0.5F + (rand.nextFloat() - rand.nextFloat()) * 0.4F;
