...
public class FlightNodeProcessor extends NodeProcessor {
   ...
   public int func_186320_a(PathPoint[] p_186320_1_, PathPoint p_186320_2_, PathPoint p_186320_3_, float p_186320_4_) {
      ...
      for (EnumFacing enumfacing : EnumFacing.values()) {
         PathPoint pathpoint = this.func_186328_b(
            p_186320_2_.field_75839_a + enumfacing.func_82601_c(),
            p_186320_2_.field_75837_b + enumfacing.func_96559_d(),
            p_186320_2_.field_75838_c + enumfacing.func_82599_e()
         );
      ...
      for (int i = p_186327_1_; i < p_186327_1_ + this.field_176168_c; i++) {
         for (int j = p_186327_2_; j < p_186327_2_ + this.field_176165_d; j++) {
            for (int k = p_186327_3_; k < p_186327_3_ + this.field_176166_e; k++) {
               ...
               if (!this.field_176169_a.func_175623_d(blockpos$mutableblockpos.func_181079_c(i, j, k))
                  && !iblockstate.func_177230_c().func_176205_b(this.field_176169_a, blockpos$mutableblockpos.func_181079_c(i, j, k))) {
