...
public class GolemProperties implements IGolemProperties {
   ...
   public Set<EnumGolemTrait> getTraits() {
      if (this.traitCache == null) {
         ...
         for (EnumGolemTrait trait : this.getMaterial().traits) {
            this.addTraitSmart(trait);
         }

         for (EnumGolemTrait trait : this.getHead().traits) {
            this.addTraitSmart(trait);
         }

         for (EnumGolemTrait trait : this.getArms().traits) {
            this.addTraitSmart(trait);
         }

         for (EnumGolemTrait trait : this.getLegs().traits) {
            this.addTraitSmart(trait);
         }

         for (EnumGolemTrait trait : this.getAddon().traits) {
            this.addTraitSmart(trait);
         }
      }
   ...
   private static void addToList(ArrayList<ItemStack> comps, ItemStack newItem, int mult) {
      ...
      stack.func_190920_e(stack.func_190916_E() * mult);
      comps.add(stack);
   }
   ...
   static {
      GolemMaterial.register(
         new GolemMaterial(
            ...
            2,
            1,
            new ItemStack(BlocksTC.plankGreatwood, 1, 0),
      ...
      GolemMaterial.register(
         new GolemMaterial(
            ...
            8,
            3,
            new ItemStack(ItemsTC.plate, 1, 1),
            new ItemStack(ItemsTC.mechanismSimple),
      ...
      GolemMaterial.register(
         new GolemMaterial(
            ...
            4,
            2,
            new ItemStack(Blocks.field_150405_ch, 1, 0),
            new ItemStack(ItemsTC.mechanismSimple),
      ...
      GolemHead.register(
         new GolemHead(
            ...
            new PartModel(new ResourceLocation("thaumcraft", "models/obj/golem_head_basic.obj"), null, PartModel.EnumAttachPoint.HEAD),
            new Object[]{new ItemStack(ItemsTC.mind, 1, 0)},
            new EnumGolemTrait[0]
         )
      );
      GolemHead.register(
         new GolemHead(
      ...
      GolemHead.register(
         new GolemHead(
            ...
            new ResourceLocation("thaumcraft", "textures/misc/golem/head_smartarmor.png"),
            new PartModel(new ResourceLocation("thaumcraft", "models/obj/golem_head_smart_armor.obj"), null, PartModel.EnumAttachPoint.HEAD),
            new Object[]{new ItemStack(ItemsTC.mind, 1, 1), new ItemStack(ItemsTC.plate), "base", new ItemStack(Blocks.field_150325_L)},
      ...
      GolemHead.register(
         new GolemHead(
            ...
            new PartModel(
               new ResourceLocation("thaumcraft", "models/obj/golem_head_scout.obj"),
               new ResourceLocation("thaumcraft", "textures/entity/golems/golem_head_other.png"),
               PartModel.EnumAttachPoint.HEAD
            ),
            new Object[]{new ItemStack(ItemsTC.mind, 1, 0), new ItemStack(ItemsTC.modules)},
      ...
      GolemHead.register(
         new GolemHead(
            ...
            new ResourceLocation("thaumcraft", "textures/misc/golem/head_smartscout.png"),
            new PartModel(
               new ResourceLocation("thaumcraft", "models/obj/golem_head_scout_smart.obj"),
               new ResourceLocation("thaumcraft", "textures/entity/golems/golem_head_other.png"),
               PartModel.EnumAttachPoint.HEAD
            ),
            new Object[]{new ItemStack(ItemsTC.mind, 1, 1), new ItemStack(ItemsTC.modules)},
      ...
      GolemArm.register(
         new GolemArm(
            ...
            new PartModel(new ResourceLocation("thaumcraft", "models/obj/golem_arms_basic.obj"), null, PartModel.EnumAttachPoint.ARMS),
            new Object[0],
            new EnumGolemTrait[0]
         )
      );
      GolemArm.register(
         new GolemArm(
            ...
            new PartModel(new ResourceLocation("thaumcraft", "models/obj/golem_arms_fine.obj"), null, PartModel.EnumAttachPoint.ARMS),
            new Object[]{new ItemStack(ItemsTC.mechanismSimple), "base"},
      ...
      GolemArm.register(
         new GolemArm(
            ...
            new PartModelClaws(
               new ResourceLocation("thaumcraft", "models/obj/golem_arms_claws.obj"),
               new ResourceLocation("thaumcraft", "textures/entity/golems/golem_arms_claws.png"),
               PartModel.EnumAttachPoint.ARMS
            ),
            new Object[]{new ItemStack(ItemsTC.modules, 1, 1), new ItemStack(Items.field_151097_aZ, 2), "base"},
      ...
      GolemArm.register(
         new GolemArm(
            ...
            new PartModelBreakers(
               new ResourceLocation("thaumcraft", "models/obj/golem_arms_breakers.obj"),
               new ResourceLocation("thaumcraft", "textures/entity/golems/golem_arms_breakers.png"),
               PartModel.EnumAttachPoint.ARMS
            ),
            new Object[]{new ItemStack(Items.field_151045_i, 2), "base", new ItemStack(Blocks.field_150331_J, 2)},
      ...
      GolemArm.register(
         new GolemArm(
            "DARTS",
            new String[]{"GOLEMCOMBATADV"},
            new ResourceLocation("thaumcraft", "textures/misc/golem/arms_darts.png"),
            new PartModelDarts(
               new ResourceLocation("thaumcraft", "models/obj/golem_arms_darter.obj"),
               new ResourceLocation("thaumcraft", "textures/entity/golems/golem_arms_darter.png"),
               PartModel.EnumAttachPoint.ARMS
            ),
            new Object[]{new ItemStack(ItemsTC.modules, 1, 1), new ItemStack(Blocks.field_150367_z, 2), new ItemStack(Items.field_151032_g, 32), "mech"},
            new GolemArmDart(),
            new EnumGolemTrait[]{EnumGolemTrait.FIGHTER, EnumGolemTrait.CLUMSY, EnumGolemTrait.RANGED, EnumGolemTrait.FRAGILE}
         )
      );
      GolemLeg.register(
         new GolemLeg(
            ...
            new PartModel(new ResourceLocation("thaumcraft", "models/obj/golem_legs_walker.obj"), null, PartModel.EnumAttachPoint.LEGS),
      ...
      GolemLeg.register(
         new GolemLeg(
            ...
            new PartModelWheel(
               new ResourceLocation("thaumcraft", "models/obj/golem_legs_wheel.obj"),
               new ResourceLocation("thaumcraft", "textures/entity/golems/golem_legs_wheel.png"),
               PartModel.EnumAttachPoint.BODY
            ),
            new Object[]{new ItemStack(Items.field_151054_z, 2), new ItemStack(Items.field_151116_aA), "mech"},
            new GolemLegWheels(),
      ...
      GolemLeg.register(
         new GolemLeg(
            ...
            new PartModel(
               new ResourceLocation("thaumcraft", "models/obj/golem_legs_climber.obj"),
               new ResourceLocation("thaumcraft", "textures/blocks/base_metal.png"),
               PartModel.EnumAttachPoint.LEGS
            ),
            new Object[]{new ItemStack(Items.field_151145_ak, 4), "base", "mech", "mech"},
      ...
      GolemLeg.register(
         new GolemLeg(
            ...
            new PartModel(
               new ResourceLocation("thaumcraft", "models/obj/golem_legs_floater.obj"),
               new ResourceLocation("thaumcraft", "textures/entity/golems/golem_legs_floater.png"),
               PartModel.EnumAttachPoint.BODY
            ),
            new Object[]{new ItemStack(BlocksTC.levitator), new ItemStack(ItemsTC.plate, 4), new ItemStack(Items.field_151123_aH), "mech"},
      ...
      GolemAddon.register(
         new GolemAddon(
            "NONE", new String[]{"MINDCLOCKWORK"}, new ResourceLocation("thaumcraft", "textures/blocks/blank.png"), null, new Object[0], new EnumGolemTrait[0]
         )
      );
      GolemAddon.register(
         new GolemAddon(
            ...
            new PartModel(new ResourceLocation("thaumcraft", "models/obj/golem_armor.obj"), null, PartModel.EnumAttachPoint.BODY),
      ...
      GolemAddon.register(
         new GolemAddon(
            ...
            null,
            new Object[]{new ItemStack(ItemsTC.modules, 1, 1), "mech"},
      ...
      GolemAddon.register(
         new GolemAddon(
            ...
            new PartModelHauler(
               new ResourceLocation("thaumcraft", "models/obj/golem_hauler.obj"),
               new ResourceLocation("thaumcraft", "textures/entity/golems/golem_hauler.png"),
               PartModel.EnumAttachPoint.BODY
            ),
            new Object[]{new ItemStack(Items.field_151116_aA), new ItemStack(Blocks.field_150486_ae)},
