...
public class ChampionModInfested implements IChampionModifierEffect {
   ...
   public float performEffect(EntityLivingBase boss, EntityLivingBase target, DamageSource source, float amount) {
      if (boss.field_70170_p.field_73012_v.nextFloat() < 0.4F && !boss.field_70170_p.field_72995_K) {
         ...
         spiderling.func_70012_b(
            boss.field_70165_t, boss.field_70163_u + boss.field_70131_O / 2.0F, boss.field_70161_v, boss.field_70170_p.field_73012_v.nextFloat() * 360.0F, 0.0F
         );
