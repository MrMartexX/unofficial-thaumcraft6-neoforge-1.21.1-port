...
public class ChampionModifier {
   ...
   public static ChampionModifier[] mods = new ChampionModifier[]{
      ...
      new ChampionModifier(13, "tainted", 0, new ChampionModTainted(), UUID.fromString("a3bb2595-8221-4140-bc73-538abcd1bbd2"))
   };
   ...
   public static AttributeModifier ATTRIBUTE_MINUS_ONE = new AttributeModifier(UUID.fromString("f48eb416-8321-46e6-8c07-a07bed729a0c"), "minus1", -1.0, 0);
