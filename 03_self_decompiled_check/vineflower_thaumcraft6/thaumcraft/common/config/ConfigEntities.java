...
public class ConfigEntities {
   ...
   public static void initEntities(IForgeRegistry<EntityEntry> iForgeRegistry) {
      ...
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "CultistPortalGreater"),
         EntityCultistPortalGreater.class,
      ...
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "CultistPortalLesser"),
         EntityCultistPortalLesser.class,
         "CultistPortalLesser",
         id++,
         Thaumcraft.instance,
         64,
      ...
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "FluxRift"), EntityFluxRift.class, "FluxRift", id++, Thaumcraft.instance, 64, 20, false
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "SpecialItem"), EntitySpecialItem.class, "SpecialItem", id++, Thaumcraft.instance, 64, 20, true
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "FollowItem"), EntityFollowingItem.class, "FollowItem", id++, Thaumcraft.instance, 64, 20, false
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "FallingTaint"), EntityFallingTaint.class, "FallingTaint", id++, Thaumcraft.instance, 64, 3, true
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "Alumentum"), EntityAlumentum.class, "Alumentum", id++, Thaumcraft.instance, 64, 20, true
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "GolemDart"), EntityGolemDart.class, "GolemDart", id++, Thaumcraft.instance, 64, 20, false
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "EldritchOrb"), EntityEldritchOrb.class, "EldritchOrb", id++, Thaumcraft.instance, 64, 20, true
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "BottleTaint"), EntityBottleTaint.class, "BottleTaint", id++, Thaumcraft.instance, 64, 20, true
      );
      ...
      EntityRegistry.registerModEntity(
         ...
         EntityCausalityCollapser.class,
         "CausalityCollapser",
         id++,
         Thaumcraft.instance,
         64,
      ...
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "FocusProjectile"), EntityFocusProjectile.class, "FocusProjectile", id++, Thaumcraft.instance, 64, 20, true
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "FocusCloud"), EntityFocusCloud.class, "FocusCloud", id++, Thaumcraft.instance, 64, 20, true
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "Focusmine"), EntityFocusMine.class, "Focusmine", id++, Thaumcraft.instance, 64, 20, true
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "TurretBasic"), EntityTurretCrossbow.class, "TurretBasic", id++, Thaumcraft.instance, 64, 3, true
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "TurretAdvanced"), EntityTurretCrossbowAdvanced.class, "TurretAdvanced", id++, Thaumcraft.instance, 64, 3, true
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "ArcaneBore"), EntityArcaneBore.class, "ArcaneBore", id++, Thaumcraft.instance, 64, 3, true
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "Golem"), EntityThaumcraftGolem.class, "Golem", id++, Thaumcraft.instance, 64, 3, true
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "EldritchWarden"),
      ...
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "EldritchGolem"),
      ...
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "CultistLeader"),
      ...
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "TaintacleGiant"),
      ...
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "BrainyZombie"),
      ...
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "GiantBrainyZombie"),
      ...
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "Wisp"), EntityWisp.class, "Wisp", id++, Thaumcraft.instance, 64, 3, false, -16129, -1
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "Firebat"), EntityFireBat.class, "Firebat", id++, Thaumcraft.instance, 64, 3, false, -16129, -806354944
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "Spellbat"), EntitySpellBat.class, "Spellbat", id++, Thaumcraft.instance, 64, 3, false, -16129, -806354944
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "Pech"), EntityPech.class, "Pech", id++, Thaumcraft.instance, 64, 3, true, -16129, -12582848
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "MindSpider"), EntityMindSpider.class, "MindSpider", id++, Thaumcraft.instance, 64, 3, true, 4996656, 4473924
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "EldritchGuardian"),
      ...
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "CultistKnight"), EntityCultistKnight.class, "CultistKnight", id++, Thaumcraft.instance, 64, 3, true, 9438728, 128
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "CultistCleric"),
      ...
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "EldritchCrab"), EntityEldritchCrab.class, "EldritchCrab", id++, Thaumcraft.instance, 64, 3, true, 8421504, 5570560
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "InhabitedZombie"),
      ...
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "ThaumSlime"), EntityThaumicSlime.class, "ThaumSlime", id++, Thaumcraft.instance, 64, 3, true, 10618530, -32513
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "TaintCrawler"),
      ...
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "Taintacle"), EntityTaintacle.class, "Taintacle", id++, Thaumcraft.instance, 64, 3, false, 10618530, 4469572
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "TaintacleTiny"), EntityTaintacleSmall.class, "TaintacleTiny", id++, Thaumcraft.instance, 64, 3, false
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "TaintSwarm"), EntityTaintSwarm.class, "TaintSwarm", id++, Thaumcraft.instance, 64, 3, false, 10618530, 16744576
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "TaintSeed"), EntityTaintSeed.class, "TaintSeed", id++, Thaumcraft.instance, 64, 20, false, 10618530, 4465237
      );
      EntityRegistry.registerModEntity(
         new ResourceLocation("thaumcraft", "TaintSeedPrime"),
      ...
      EntityPech.valuedItems.put(Item.func_150891_b(Items.field_151079_bi), 15);
      ...
      forInv.add(Arrays.asList(2, new ItemStack(Items.field_185157_bK)));
      ...
      forInv.add(Arrays.asList(5, new ItemStack(Items.field_190929_cY)));
      EntityPech.tradeInventory.put(1, forMag);
      ArrayList<List> forArc = new ArrayList<>();

      for (int a = 0; a < 15; a++) {
         forArc.add(Arrays.asList(1, new ItemStack(BlocksTC.candles.get(EnumDyeColor.func_176766_a(a)))));
      }

      forArc.add(Arrays.asList(2, new ItemStack(Items.field_151073_bk)));
      forInv.add(Arrays.asList(2, new ItemStack(Items.field_151111_aL)));
      ...
      forInv.add(Arrays.asList(4, new ItemStack(Items.field_185166_h)));
   ...
   public static void postInitEntitySpawns() {
      ...
      UnmodifiableIterator allBiomes = BiomeManager.getBiomes(BiomeType.WARM).iterator();

      while (allBiomes.hasNext()) {
         BiomeEntry be = (BiomeEntry)allBiomes.next();
         biomes.add(be.biome);
      }

      allBiomes = BiomeManager.getBiomes(BiomeType.COOL).iterator();
      ...
      allBiomes = BiomeManager.getBiomes(BiomeType.ICY).iterator();
      ...
      allBiomes = BiomeManager.getBiomes(BiomeType.DESERT).iterator();
      ...
      Biome[] allBiomesx = biomes.toArray(new Biome[]{null});
      ...
      if (ModConfig.CONFIG_WORLD.allowSpawnPech) {
         for (Biome bgb : BiomeDictionary.getBiomes(Type.MAGICAL)) {
            if (bgb != null && bgb.func_76747_a(EnumCreatureType.MONSTER) != null & bgb.func_76747_a(EnumCreatureType.MONSTER).size() > 0) {
      ...
      if (ModConfig.CONFIG_WORLD.allowSpawnFireBat) {
         EntityRegistry.addSpawn(EntityFireBat.class, 10, 1, 2, EnumCreatureType.MONSTER, BiomeDictionary.getBiomes(Type.NETHER).toArray(new Biome[0]));
         Calendar calendar = Calendar.getInstance();
         calendar.setTimeInMillis(System.currentTimeMillis());
         if (calendar.get(2) + 1 == 10 && calendar.get(5) == 31) {
            EntityRegistry.addSpawn(EntityFireBat.class, 5, 1, 2, EnumCreatureType.MONSTER, biomes.toArray(allBiomesx));
         }
      }

      if (ModConfig.CONFIG_WORLD.allowSpawnWisp) {
         EntityRegistry.addSpawn(EntityWisp.class, 5, 1, 1, EnumCreatureType.MONSTER, BiomeDictionary.getBiomes(Type.NETHER).toArray(new Biome[0]));
      }
