...
public class ConfigBlocks {
   ...
   public static void initBlocks(IForgeRegistry<Block> iForgeRegistry) {
      ...
      BlocksTC.slabArcaneStone = (BlockSlab)new BlockSlabTC.Half("slab_arcane_stone", null, false).func_149711_c(2.0F).func_149752_b(10.0F);
      BlocksTC.doubleSlabArcaneStone = (BlockSlab)new BlockSlabTC.Double("slab_double_arcane_stone", BlocksTC.slabArcaneStone, false)
         .func_149711_c(2.0F)
         .func_149752_b(10.0F);
      BlocksTC.slabArcaneBrick = (BlockSlab)new BlockSlabTC.Half("slab_arcane_brick", null, false).func_149711_c(2.0F).func_149752_b(10.0F);
      BlocksTC.doubleSlabArcaneBrick = (BlockSlab)new BlockSlabTC.Double("slab_double_arcane_brick", BlocksTC.slabArcaneBrick, false)
         .func_149711_c(2.0F)
         .func_149752_b(10.0F);
      BlocksTC.slabAncient = (BlockSlab)new BlockSlabTC.Half("slab_ancient", null, false).func_149711_c(2.0F).func_149752_b(10.0F);
      BlocksTC.doubleSlabAncient = (BlockSlab)new BlockSlabTC.Double("slab_double_ancient", BlocksTC.slabAncient, false)
         .func_149711_c(2.0F)
         .func_149752_b(10.0F);
      BlocksTC.slabEldritch = (BlockSlab)new BlockSlabTC.Half("slab_eldritch", null, false).func_149711_c(2.0F).func_149752_b(10.0F);
      BlocksTC.doubleSlabEldritch = (BlockSlab)new BlockSlabTC.Double("slab_double_eldritch", BlocksTC.slabEldritch, false)
         .func_149711_c(2.0F)
         .func_149752_b(10.0F);
      ...
      ForgeRegistries.ITEMS
         .register(
            new ItemSlab(BlocksTC.slabArcaneStone, BlocksTC.slabArcaneStone, BlocksTC.doubleSlabArcaneStone)
               .setRegistryName(BlocksTC.slabArcaneStone.getRegistryName())
         );
      ForgeRegistries.ITEMS
         .register(
            new ItemSlab(BlocksTC.slabArcaneBrick, BlocksTC.slabArcaneBrick, BlocksTC.doubleSlabArcaneBrick)
               .setRegistryName(BlocksTC.slabArcaneBrick.getRegistryName())
         );
      ForgeRegistries.ITEMS
         .register(new ItemSlab(BlocksTC.slabAncient, BlocksTC.slabAncient, BlocksTC.doubleSlabAncient).setRegistryName(BlocksTC.slabAncient.getRegistryName()));
      ForgeRegistries.ITEMS
         .register(
            new ItemSlab(BlocksTC.slabEldritch, BlocksTC.slabEldritch, BlocksTC.doubleSlabEldritch).setRegistryName(BlocksTC.slabEldritch.getRegistryName())
         );
      ...
      BlocksTC.slabGreatwood = (BlockSlab)new BlockSlabTC.Half("slab_greatwood", null, true).func_149711_c(1.2F).func_149752_b(2.0F);
      BlocksTC.doubleSlabGreatwood = (BlockSlab)new BlockSlabTC.Double("slab_double_greatwood", BlocksTC.slabGreatwood, true)
         .func_149711_c(1.2F)
         .func_149752_b(2.0F);
      BlocksTC.slabSilverwood = (BlockSlab)new BlockSlabTC.Half("slab_silverwood", null, true).func_149711_c(1.0F).func_149752_b(2.0F);
      BlocksTC.doubleSlabSilverwood = (BlockSlab)new BlockSlabTC.Double("slab_double_silverwood", BlocksTC.slabSilverwood, true)
         .func_149711_c(1.0F)
         .func_149752_b(2.0F);
      ...
      ForgeRegistries.ITEMS
         .register(
            new ItemSlab(BlocksTC.slabGreatwood, BlocksTC.slabGreatwood, BlocksTC.doubleSlabGreatwood)
               .setRegistryName(BlocksTC.slabGreatwood.getRegistryName())
         );
      ForgeRegistries.ITEMS
         .register(
            new ItemSlab(BlocksTC.slabSilverwood, BlocksTC.slabSilverwood, BlocksTC.doubleSlabSilverwood)
               .setRegistryName(BlocksTC.slabSilverwood.getRegistryName())
         );
      ...
      for (EnumDyeColor dye : EnumDyeColor.values()) {
         BlockBannerTC block = new BlockBannerTC("banner_" + dye.func_176762_d().toLowerCase(), dye);
      ...
      ForgeRegistries.ITEMS
         .register(new BlockBannerTCItem((BlockBannerTC)BlocksTC.bannerCrimsonCult).setRegistryName(BlocksTC.bannerCrimsonCult.getRegistryName()));
      ...
      BlocksTC.activatorRail = registerBlock(
         ((Block)new BlockRailPowered().func_149711_c(0.7F).func_149647_a(ConfigItems.TABTC).setRegistryName("thaumcraft", "activator_rail"))
            .func_149663_c("activator_rail")
      );
