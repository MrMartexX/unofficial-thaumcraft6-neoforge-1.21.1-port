...
public class ConfigResearch {
   ...
   private static void initCategories() {
      ...
      ResearchCategories.registerCategory(
         "AUROMANCY",
         "UNLOCKAUROMANCY",
         new AspectList().add(Aspect.AURA, 20).add(Aspect.MAGIC, 20).add(Aspect.FLUX, 15).add(Aspect.CRYSTAL, 5).add(Aspect.COLD, 5).add(Aspect.AIR, 5),
   ...
   private static void initScannables() {
      ...
      for (ResourceLocation loc : Enchantment.field_185264_b.func_148742_b()) {
      ...
      for (ResourceLocation loc : Potion.field_188414_b.func_148742_b()) {
      ...
      ScanningManager.addScannableThing(
         new ScanBlock(
            ...
            BlocksTC.saplingGreatwood,
            BlocksTC.saplingSilverwood,
            BlocksTC.cinderpearl,
      ...
      ScanningManager.addScannableThing(new ScanBlock("f_TELEPORT", Blocks.field_150427_aO, Blocks.field_150384_bq, Blocks.field_150378_br));
      ...
      ScanningManager.addScannableThing(new ScanBlock("f_DISPENSER", Blocks.field_150367_z));
      ...
      ScanningManager.addScannableThing(new ScanBlock("f_MATCLAY", Blocks.field_150405_ch, Blocks.field_150406_ce));
      ScanningManager.addScannableThing(new ScanMaterial("f_MATCLAY", Material.field_151571_B));
      ...
      ScanningManager.addScannableThing(new ScanItem("f_arrow", new ItemStack(Items.field_151032_g)));
   ...
   public static void checkPeriodicStuff(EntityPlayer player) {
      ...
      if (!knowledge.isResearchKnown("m_hellandback") && BiomeDictionary.hasType(biome, Type.NETHER)) {
         knowledge.addResearch("m_hellandback");
         knowledge.sync((EntityPlayerMP)player);
         player.func_146105_b(new TextComponentString(TextFormatting.DARK_PURPLE + I18n.func_74838_a("got.hellandback")), true);
      }

      if (!knowledge.isResearchKnown("m_endoftheworld") && BiomeDictionary.hasType(biome, Type.END)) {
         knowledge.addResearch("m_endoftheworld");
         knowledge.sync((EntityPlayerMP)player);
         player.func_146105_b(new TextComponentString(TextFormatting.DARK_PURPLE + I18n.func_74838_a("got.endoftheworld")), true);
      }
      ...
      if (knowledge.isResearchKnown("UNLOCKAUROMANCY@1") && !knowledge.isResearchKnown("UNLOCKAUROMANCY@2")) {
         ...
         if (player.field_70163_u > player.func_130014_f_().func_72940_L() * 0.4 && !knowledge.isResearchKnown("m_uphigh")) {
            ...
            knowledge.sync((EntityPlayerMP)player);
            player.func_146105_b(new TextComponentString(TextFormatting.DARK_PURPLE + I18n.func_74838_a("got.uphigh")), true);
         }
      }
