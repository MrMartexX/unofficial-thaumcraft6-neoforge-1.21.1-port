...
public class ConfigItems {
   ...
   public static void initItems(IForgeRegistry<Item> iForgeRegistry) {
      ...
      iForgeRegistry.register(
         ItemsTC.nuggets = new ItemTCBase(
            "nugget", "iron", "copper", "tin", "silver", "lead", "quicksilver", "thaumium", "void", "brass", "quartz", "rareearth"
         )
      );
      ...
      iForgeRegistry.register(
         ItemsTC.voidRobeHelm = new ItemVoidRobeArmor("void_robe_helm", ThaumcraftMaterials.ARMORMAT_VOIDROBE, 4, EntityEquipmentSlot.HEAD)
      );
      iForgeRegistry.register(
         ItemsTC.voidRobeChest = new ItemVoidRobeArmor("void_robe_chest", ThaumcraftMaterials.ARMORMAT_VOIDROBE, 4, EntityEquipmentSlot.CHEST)
      );
      iForgeRegistry.register(
         ItemsTC.voidRobeLegs = new ItemVoidRobeArmor("void_robe_legs", ThaumcraftMaterials.ARMORMAT_VOIDROBE, 4, EntityEquipmentSlot.LEGS)
      );
      iForgeRegistry.register(
         ItemsTC.crimsonPlateHelm = new ItemCultistPlateArmor("crimson_plate_helm", ThaumcraftMaterials.ARMORMAT_CULTIST_PLATE, 4, EntityEquipmentSlot.HEAD)
      );
      iForgeRegistry.register(
         ItemsTC.crimsonPlateChest = new ItemCultistPlateArmor("crimson_plate_chest", ThaumcraftMaterials.ARMORMAT_CULTIST_PLATE, 4, EntityEquipmentSlot.CHEST)
      );
      iForgeRegistry.register(
         ItemsTC.crimsonPlateLegs = new ItemCultistPlateArmor("crimson_plate_legs", ThaumcraftMaterials.ARMORMAT_CULTIST_PLATE, 4, EntityEquipmentSlot.LEGS)
      );
      iForgeRegistry.register(ItemsTC.crimsonBoots = new ItemCultistBoots());
      iForgeRegistry.register(
         ItemsTC.crimsonRobeHelm = new ItemCultistRobeArmor("crimson_robe_helm", ThaumcraftMaterials.ARMORMAT_CULTIST_ROBE, 4, EntityEquipmentSlot.HEAD)
      );
      iForgeRegistry.register(
         ItemsTC.crimsonRobeChest = new ItemCultistRobeArmor("crimson_robe_chest", ThaumcraftMaterials.ARMORMAT_CULTIST_ROBE, 4, EntityEquipmentSlot.CHEST)
      );
      iForgeRegistry.register(
         ItemsTC.crimsonRobeLegs = new ItemCultistRobeArmor("crimson_robe_legs", ThaumcraftMaterials.ARMORMAT_CULTIST_ROBE, 4, EntityEquipmentSlot.LEGS)
      );
      ...
      if (item.getCustomMesh() != null) {
         ...
         for (int i = 0; i < item.getVariantNames().length; i++) {
            ModelLoader.setCustomModelResourceLocation(
               item.getItem(), item.getVariantMeta()[i], new ModelResourceLocation(item.getItem().getRegistryName() + "_" + item.getVariantNames()[i], null)
            );
         }
