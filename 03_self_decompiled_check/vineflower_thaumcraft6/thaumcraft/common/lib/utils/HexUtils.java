...
public class HexUtils {
   ...
   public static class Hex {
      ...
      public HexUtils.Pixel toPixel(int size) {
         return new HexUtils.Pixel(size * 1.5 * this.q, size * Math.sqrt(3.0) * (this.r + this.q / 2.0));
      }
   ...
   public static class Pixel {
      ...
      public HexUtils.Hex toHex(int size) {
         double qq = 0.6666666666666666 * this.x / size;
         double rr = (0.3333333333333333 * Math.sqrt(3.0) * -this.y - 0.3333333333333333 * this.x) / size;
