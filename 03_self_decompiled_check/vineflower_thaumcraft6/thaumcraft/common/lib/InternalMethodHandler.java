   ...
   public void addWarpToPlayer(EntityPlayer player, int amount, IPlayerWarp.EnumWarpType type) {
      if (amount != 0 && !player.field_70170_p.field_72995_K) {
         ...
         if (type != IPlayerWarp.EnumWarpType.TEMPORARY
            ...
            player.func_146105_b(new TextComponentTranslation("research.WARP.warn", new Object[0]), true);
         }
      ...
      if (!world.field_72995_K) {
         ...
         if (showEffect && amount > 0.0F) {
            PacketHandler.INSTANCE
               .sendToAllAround(
                  new PacketFXPollute(pos, amount),
                  new TargetPoint(world.field_73011_w.getDimension(), pos.func_177958_n(), pos.func_177956_o(), pos.func_177952_p(), 32.0)
               );
         }
      }
   }
