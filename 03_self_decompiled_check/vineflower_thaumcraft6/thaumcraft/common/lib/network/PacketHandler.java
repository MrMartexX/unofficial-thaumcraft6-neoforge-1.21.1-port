...
public class PacketHandler {
   ...
   public static void preInit() {
      ...
      INSTANCE.registerMessage(PacketKnowledgeGain.class, PacketKnowledgeGain.class, idx++, Side.CLIENT);
      INSTANCE.registerMessage(PacketStartTheoryToServer.class, PacketStartTheoryToServer.class, idx++, Side.SERVER);
      INSTANCE.registerMessage(PacketLogisticsRequestToServer.class, PacketLogisticsRequestToServer.class, idx++, Side.SERVER);
      INSTANCE.registerMessage(PacketMiscStringToServer.class, PacketMiscStringToServer.class, idx++, Side.SERVER);
      INSTANCE.registerMessage(PacketSelectThaumotoriumRecipeToServer.class, PacketSelectThaumotoriumRecipeToServer.class, idx++, Side.SERVER);
      INSTANCE.registerMessage(PacketItemToClientContainer.class, PacketItemToClientContainer.class, idx++, Side.CLIENT);
      INSTANCE.registerMessage(PacketTileToServer.class, PacketTileToServer.class, idx++, Side.SERVER);
      INSTANCE.registerMessage(PacketTileToClient.class, PacketTileToClient.class, idx++, Side.CLIENT);
      INSTANCE.registerMessage(PacketFocusNodesToServer.class, PacketFocusNodesToServer.class, idx++, Side.SERVER);
      INSTANCE.registerMessage(PacketFocusNameToServer.class, PacketFocusNameToServer.class, idx++, Side.SERVER);
      INSTANCE.registerMessage(PacketAuraToClient.class, PacketAuraToClient.class, idx++, Side.CLIENT);
      INSTANCE.registerMessage(PacketSealToClient.class, PacketSealToClient.class, idx++, Side.CLIENT);
      INSTANCE.registerMessage(PacketSealFilterToClient.class, PacketSealFilterToClient.class, idx++, Side.CLIENT);
      ...
      INSTANCE.registerMessage(PacketSyncKnowledge.class, PacketSyncKnowledge.class, idx++, Side.CLIENT);
      ...
      INSTANCE.registerMessage(PacketSyncProgressToServer.class, PacketSyncProgressToServer.class, idx++, Side.SERVER);
      INSTANCE.registerMessage(PacketSyncResearchFlagsToServer.class, PacketSyncResearchFlagsToServer.class, idx++, Side.SERVER);
      INSTANCE.registerMessage(PacketPlayerFlagToServer.class, PacketPlayerFlagToServer.class, idx++, Side.SERVER);
      INSTANCE.registerMessage(PacketFXPollute.class, PacketFXPollute.class, idx++, Side.CLIENT);
      INSTANCE.registerMessage(PacketFXBlockBamf.class, PacketFXBlockBamf.class, idx++, Side.CLIENT);
      INSTANCE.registerMessage(PacketFXFocusEffect.class, PacketFXFocusEffect.class, idx++, Side.CLIENT);
      INSTANCE.registerMessage(PacketFXFocusPartImpact.class, PacketFXFocusPartImpact.class, idx++, Side.CLIENT);
      INSTANCE.registerMessage(PacketFXFocusPartImpactBurst.class, PacketFXFocusPartImpactBurst.class, idx++, Side.CLIENT);
      INSTANCE.registerMessage(PacketFXBlockMist.class, PacketFXBlockMist.class, idx++, Side.CLIENT);
      ...
      INSTANCE.registerMessage(PacketFXSlash.class, PacketFXSlash.class, idx++, Side.CLIENT);
      INSTANCE.registerMessage(PacketFXScanSource.class, PacketFXScanSource.class, idx++, Side.CLIENT);
      INSTANCE.registerMessage(PacketFXBoreDig.class, PacketFXBoreDig.class, idx++, Side.CLIENT);
   }
}
