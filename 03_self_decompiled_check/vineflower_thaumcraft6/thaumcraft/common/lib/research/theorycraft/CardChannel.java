...
public class CardChannel extends TheorycraftCard {
   ...
   public String getLocalizedName() {
      return new TextComponentTranslation(
            "card.channel.name", new Object[]{TextFormatting.DARK_BLUE + this.aspect.getName() + TextFormatting.RESET + "" + TextFormatting.BOLD}
         )
         .func_150254_d();
   }
   ...
   public String getLocalizedText() {
      return new TextComponentTranslation("card.channel.text", new Object[]{TextFormatting.BOLD + this.aspect.getName() + TextFormatting.RESET})
         .func_150254_d();
   }
