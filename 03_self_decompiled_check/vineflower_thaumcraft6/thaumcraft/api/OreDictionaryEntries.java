...
public class OreDictionaryEntries {
   public static void initializeOreDictionary() {
      ...
      OreDictionary.registerOre("treeLeaves", new ItemStack(BlocksTC.leafGreatwood, 1, 32767));
      OreDictionary.registerOre("treeLeaves", new ItemStack(BlocksTC.leafSilverwood, 1, 32767));
      ...
      OreDictionary.registerOre("trapdoorWood", new ItemStack(Blocks.field_150415_aT));
   }
}
