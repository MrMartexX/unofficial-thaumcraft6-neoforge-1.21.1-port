...
- Entry and recipe page navigation no longer uses invented persistent text buttons. Main page arrows, recipe-page arrows, the hidden/hover return zone, Escape/Inventory close behavior, Backspace recipe-history behavior and return hover text follow the legacy `GuiResearchPage` navigation model.
