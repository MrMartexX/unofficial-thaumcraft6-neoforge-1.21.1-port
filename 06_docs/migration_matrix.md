...
| Java | `21` |
| Mod id | `thaumcraft` |
| Project state | Gate 0 complete enough to continue; Gate 1 and early Gate 2 identity work are in progress |
...
| Gate 2 | Block identity | Simple blocks, block items, models and loot | Started early | BlockEntity machines |
...
| Gate 11 | Worldgen | Features, trees, biomes and structures | Not started as a system | Unsafe direct old generators |
| Gate 12 | Rendering and FX | BERs, entity renderers, particles and overlays | Minimal plant particle polish only | Raw GL copy-paste |
...
| 5 | Simple item registry | `DeferredRegister.Items`, item models, lang, textures, tags | Medium | Audit implemented item assets | In progress |
...
| 10 | Basic blocks | `DeferredRegister.Blocks`, block items, blockstates, models, loot tables | Medium | Audit implemented simple blocks | In progress |
...
| 27 | Worldgen | Datapack/datagen features, biome modifiers, structures | Critical | Design worldgen data mapping first | Port later |
| 28 | Rendering and FX | BERs, entity renderers, particles, overlays, `PoseStack` | Critical | Port only after server logic exists | Port later |
