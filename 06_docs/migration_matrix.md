...
| Gate 4 | Basic BlockEntities | Storage, ticking and save/load | Started narrowly with research table slots, menu opening data, theory data save/load, and first bookshelf aid scan integration | Full theory data/card/aids polish |
...
| Gate 8 | Menus and Screens | Modern GUI for machines and research | Started narrowly with the research table inventory menu, background screen, minimal theory controls, and bookshelf aid selection | Large visual overhaul |
