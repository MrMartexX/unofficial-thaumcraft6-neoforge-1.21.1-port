...
| Mapped runtime parity report | `1138` comparable keys | `1138` identical, including `283` explicit legacy-to-modern id/meta mappings. Remaining real mapped gaps are `0`: potion content/order parity, enchanted-book parity, and registered Thaumcraft set parity are closed. |
