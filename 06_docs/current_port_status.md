...
- Row 6-11 blocker regression was re-run together on 2026-07-20: item/equipment `17/17`, focus/caster core `10/10`, focus cast execution `5/5`, research data `0` source/runtime/category diffs with `10/10` progression checks, Thaumonomicon protocol `36/36`, page catalog `203 READY` / `0 DEFERRED` / `0 LEGACY_MISSING`, crucible behavior `16/16`, special alchemy `32/32`, alchemy automation `11/11`, crucible recipe data `77/77`, Thaumatorium `19/19`, transport `61/61`, Flux/Bore/Thaumatorium `11/11`, Flux Rift consequence `21/21`, Wisp `11/11`, spawn policy `34/34`, Flux Goo/Taint Fibre `13/13`, Taint ecology `15/15`, Taint mob `15/15`, FallingTaint `10/10`, and entity foundation `71/71`. The sweep fixed a Thaumatorium audit isolation bug caused by persistent fake-player research knowledge, restored legacy `.jpg` research-category background ids, made the crucible recipe-data audit script compatible with Windows PowerShell 5, and closed the rift-owned focus-cloud event-3 blocker with a registered invisible `focus_cloud` entity and runtime audit coverage. Final measured pixel-level visual parity remains row 17 work.
