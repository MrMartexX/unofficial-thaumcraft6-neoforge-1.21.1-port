...
| Next subsystem | Theorycraft advanced card/aids by dependency family. | Bookshelf aid now proves the start-theory aid path. The next safe step is visual client checking, then cards/aids that depend only on already-portable identities. |
...
12. Visually check bookshelf aid selection in `runClient`; then port remaining theorycraft cards/aids only by audited dependency family. Advanced cards that require warp, curios, focus/caster, infusion, celestial notes, portals, beacon/enchantment aids, or other unported systems must stay deferred or explicitly bridged.
