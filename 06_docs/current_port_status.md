...
| Check | Result | Notes |
|---|---|---|
| `.\gradlew.bat build --no-daemon` | Passed | Latest Arcane Workbench regular-recipe and equipment-discount bridge batch builds successfully. Re-run after each recipe, UI, menu, networking, gameplay or asset expansion batch. |
