...
Last reviewed checkpoint: `2026-07-11` taint mob and Thaumic Slime blocker slice
...
- Both active item-entity types use the vanilla item entity renderer for now. Newly server-complete taint mobs use explicit no-op renderer placeholders until measured renderer/model parity is implemented. The remaining deferred legacy custom entities are classified by owning subsystem: FallingTaint, projectiles, focus projectile/cloud/mine, constructs/turrets, Eldritch/Crimson mobs and golems.
...
- Current validation: `TCEntityFoundationAudit` passes `21/21` and writes `06_docs/audits/generated/thaumcraft_1_21_entity_foundation_audit.md`. The focused Flux/Bore/Thaumatorium blocker audit passes `11/11` and writes `06_docs/audits/generated/thaumcraft_1_21_flux_bore_thaumatorium_blocker_audit.md`; the focused taint ecology blocker audit passes `15/15`; the focused taint mob blocker audit passes `14/14` and writes `06_docs/audits/generated/thaumcraft_1_21_taint_mob_blocker_audit.md`. This does not claim final custom mob renderer/model/particle parity, FallingTaint crust physics, full Flux Rift event consequences, full turrets or golem logistics parity.
