...
11. Add research table parity fixtures for `TCResearchTableData` NBT, paper draw, scribing-tool damage, inspiration calculation, category totals, selected-card commit, and finish-theory raw knowledge conversion.
