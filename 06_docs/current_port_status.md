...
Last reviewed checkpoint: `2026-07-02` custom entity foundation slice
...
- Current validation: `TCEntityFoundationAudit` passes `7/7` and writes `06_docs/audits/generated/thaumcraft_1_21_entity_foundation_audit.md`. This is a registry/foundation audit only; it does not claim AI, spawn rules, custom renderers, entity aspects for Thaumcraft custom mobs or golem logistics parity.
...
- Bellows, lamps and Infernal Furnace now have focused device slices with dedicated runtime audits. Remaining standalone-device blockers include Arcane Bore, Void Siphon and any explicit Infernal Furnace multiblock activation work; final measured device item/block pixel parity remains visual review work.
...
| Entities/golems | Foundation started | `TCEntityTypes` registers the first two non-mob item-entity types, `special_item` and `follow_item`, and keeps the full 43-entry legacy entity catalog explicit for future batches. Runtime entity foundation audit passes `7/7`. Mob AI, spawn rules, attributes, custom renderers, focus projectile/cloud/mine entities, Flux Rift, Arcane Bore/turrets and golems remain deferred. |
