...
8. For the next crucible/Thaumatorium gameplay batch, keep `TCSpecialAlchemyBehaviorAudit` green and audit the remaining automation owner before wiring taint mob natural-spawn/rendering parity, Thaumic Slime polish, broader automation behavior or focus-cloud-owned Flux Rift event execution.
