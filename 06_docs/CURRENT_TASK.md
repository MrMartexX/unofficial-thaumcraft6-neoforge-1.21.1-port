...
1. Continue blocker-removal work outside the focus/caster layer unless explicitly requested.
   ...
   - Row 14 now has an entity registry foundation, safe legacy item/projectile entity implementations including `BottleTaint`, focused Flux Rift/Arcane Bore entity foundations, Wisp behavior/render/spawn contracts, and the first taint mob server behavior contracts. Do not expand this into golems, focus projectiles/clouds/mines or broad custom renderers without a focused design/audit slice.
