...
- Do not expand this further into Flux Rift focus-cloud event execution, rift visual parity, taint mob natural-spawn/rendering parity, Thaumic Slime polish, essentia networks, broader automation or exact fluid render/particle parity without a new focused slice. The legacy crucible item entity path is collision-only; avoid adding a fake radius pull to the crucible.
