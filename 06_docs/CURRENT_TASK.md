...
1. Continue exact arcane recipe expansion by audited dependency family; prefer bridge-only recipe cleanups where outputs already exist but gameplay is deferred.
