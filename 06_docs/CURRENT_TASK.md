...
1. Continue blocker-removal work outside the focus/caster layer unless explicitly requested.
   ...
   - Row 13 now has closed standalone device sub-slices for normal item Mirror/Magic Hand Mirror and Arcane/Growth/Fertility Lamps. Continue row 13 with the next isolated device family instead of returning to focus/caster.
