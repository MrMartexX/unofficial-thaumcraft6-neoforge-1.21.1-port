...
1. Continue blocker-removal work outside the focus/caster layer unless explicitly requested.
   ...
   - Row 7/15 now has the focused Brain-in-a-Jar server/theorycraft blocker slice and the registered `CardTruth` Eldritch theorycraft card. Keep exact animated model parity, item-warp registry, `AidBasicEldritch`, Crimson portal aid and broader golem/mind behavior as separate focused work.
