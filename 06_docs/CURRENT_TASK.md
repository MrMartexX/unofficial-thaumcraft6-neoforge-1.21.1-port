...
2. Keep already closed behavior audits green after related changes:
   ...
   - Thaumonomicon protocol audit: `41/41`.
...
- Current protocol audit result: `41/41`, including server-owned vanilla crafting, arcane, crucible, infusion, blueprint and fake display page snapshots, selected-stage warp propagation, side-panel state, runtime PNG category background validation and recipe drilldown/history validation.
