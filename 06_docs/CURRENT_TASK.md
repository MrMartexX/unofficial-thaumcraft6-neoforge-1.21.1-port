...
1. Continue blocker-removal work outside the focus/caster layer unless explicitly requested.
   ...
   - Row 9 now has the focused special alchemy behavior slice for Bath Salts, Bottled Taint, real Liquid Death/Purifying Fluid, Warp Ward and Sanity Soap bonuses. Keep exact client fluid particles/render translucency, Liquid Death custom dissolve damage type identity, item-pulling radius, crucible-derived aspect generation and broader automation integration under focused follow-up slices.
...
2. Keep already closed behavior audits green after related changes:
   ...
   - Special alchemy behavior audit: `13/13`.
...
- Do not expand this further into Flux Rift focus-cloud event execution, rift visual parity, taint mob natural-spawn/rendering parity, Thaumic Slime polish, essentia networks, broader automation, item pulling radius, exact fluid render/particle parity or Liquid Death custom damage-source identity without a new focused slice.
