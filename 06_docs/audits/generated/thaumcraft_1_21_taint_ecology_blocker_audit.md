...
- Deferred from this ecology audit: FallingTaint crust physics, GORE sound parity, exact animated TaintSeed model parity and final taint mob renderer/natural-spawn parity. Taint mob server-foundation hooks are covered by TCTaintMobBlockerAudit.
