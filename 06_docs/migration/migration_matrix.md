...
- Full focus effect execution, Focus Pouch inventory GUI, Brain-in-a-Jar, Crimson portal, Basic Eldritch, Dragon Egg theorycraft, remaining custom mob/projectile/construct/golem behavior, remaining standalone device families after mirrors/lamps, final measured infusion/equipment/focus/lamp visual tuning, and broad render/worldgen systems remain deferred/reference-only until their dependencies are designed.
