...
- Brain-in-a-Jar, Crimson portal, Basic Eldritch, Dragon Egg theorycraft, remaining custom entities, broad essentia behavior, exact per-cycle infusion completion/instability/FX, and broad render/worldgen systems remain deferred/reference-only until their dependencies are designed.
