...
- Full focus effect execution, Focus Pouch inventory GUI, Brain-in-a-Jar, Crimson portal, Basic Eldritch, Dragon Egg theorycraft, remaining custom entities, broad essentia utility devices, final measured infusion/equipment/focus visual tuning, and broad render/worldgen systems remain deferred/reference-only until their dependencies are designed.
