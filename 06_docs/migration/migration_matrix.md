...
- Gate 1 and early Gate 2 identity work are in progress: active resources are runtime-audited, legacy asset corpus is imported as reference/base material, and public ids for candles, tubes, Alembic, Bellows and smelter attachments use legacy names. Detailed legacy-derived machine models remain authoritative over cube placeholders.
...
- Brain-in-a-Jar, Crimson portal, Basic Eldritch, Dragon Egg theorycraft, remaining custom entities, broad essentia behavior, final measured infusion visual tuning, and broad render/worldgen systems remain deferred/reference-only until their dependencies are designed.
