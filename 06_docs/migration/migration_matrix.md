...
4. Do not expand in-world crucible, infusion, essentia transport, Thaumatorium GUI/rendering, broad worldgen, broad rendering, or integrations without a focused design note and validation path.
