...
- Focus/caster gameplay, Brain-in-a-Jar, Crimson portal, Basic Eldritch, Dragon Egg theorycraft, remaining custom entities, broad essentia utility devices, final measured infusion/equipment visual tuning, and broad render/worldgen systems remain deferred/reference-only until their dependencies are designed.
...
| Gate 1 | Item identity | Safe simple items and creative tab order scaffold | In progress, expanded beyond first slice; active item models/lang covered; first safe equipment/utility behavior contracts audited `17/17` | Focus/caster gameplay, full accessory integration, broad rendering |
