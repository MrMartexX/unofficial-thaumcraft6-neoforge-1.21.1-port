...
| Stage 9. GUI | In progress | Research Table, Arcane Workbench, smelter, Hand Mirror sender, Thaumatorium recipe selection, Focal Manipulator minimal core screen and first Thaumonomicon screens exist as functional slices; final visual parity and recipe drilldown remain incomplete. |
