...
| Stage 10. Networking | In progress | Aura, knowledge, research table, Thaumonomicon protocol version `9`, both clientbound infusion FX payload contracts, Wisp zap FX payload and the Focal Manipulator design-intent payload exist; future gameplay payloads need subsystem-specific design. |
