...
| Stage 9. GUI | In progress | Research Table, Arcane Workbench, smelter, Hand Mirror sender, Thaumatorium recipe selection, Focal Manipulator minimal core screen and first Thaumonomicon screens exist as functional slices; Thaumonomicon search and recipe drilldown/history are server-authoritative. Final visual parity and remaining fake/blueprint/special recipe pages remain incomplete. |
