...
| Stage 8. Tile Entities | In progress | Research Table, Arcane Workbench, Crucible, Infusion Matrix/Pedestals, Focal Manipulator, tubes, Warded Jar, Void Jar, Essentia Mirror, Alembic, Bellows and all three smelter tiers own persisted server state. The combined transport/smelter/label/phial/caster-control/Void-Jar/essentia-mirror audit passes `61/61`; Bellows and focus/caster core have dedicated audits. |
