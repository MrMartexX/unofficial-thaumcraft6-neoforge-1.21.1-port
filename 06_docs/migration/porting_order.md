...
| Stage 3. Blocks / Basic Resources | In progress | Basic blocks, candles, tables, Arcane Workbench and Arcane/Growth/Fertility lamp blocks exist; all six tube blocks now use legacy multipart connection topology and shapes. Broad machine behavior remains incomplete. |
