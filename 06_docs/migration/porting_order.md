...
| Stage 13. Rendering / Particles | In progress | Thaumometer effects, table renderer, infusion FX, crucible FX, legacy multipart tube geometry and valve/vent state rendering exist; lamp block/item models are functional for the device slice, but measured visual parity and broad render/BEWLR/shader work remain high risk. |
