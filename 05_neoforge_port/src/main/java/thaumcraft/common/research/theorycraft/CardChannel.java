...
final class CardChannel extends TCTheorycraftCard {
    ...
    public Component getLocalizedName() {
        return Component.translatable("card.channel.name", CardConcentrate.aspectName(aspect));
    }

    @Override
    public Component getLocalizedText() {
        return Component.translatable("card.channel.text", CardConcentrate.aspectName(aspect));
    }

    @Override
    public List<ItemStack> getRequiredItems() {
        return List.of(TCAspectVariantStacks.phial(aspect));
    }
