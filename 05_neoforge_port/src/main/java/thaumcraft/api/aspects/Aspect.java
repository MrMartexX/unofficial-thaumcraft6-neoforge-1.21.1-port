...
public class Aspect {
    ...
    public Aspect(String tag, int color, Aspect[] components) {
        this(tag, color, components, aspectImage(tag), 1);
    }

    public Aspect(String tag, int color, Aspect[] components, int blend) {
        this(tag, color, components, aspectImage(tag), blend);
    }
    ...
    public ResourceLocation getId() {
        return ResourceLocation.fromNamespaceAndPath(Thaumcraft.MODID, tag);
    }

    private static ResourceLocation aspectImage(String tag) {
        return ResourceLocation.fromNamespaceAndPath(Thaumcraft.MODID, "textures/aspects/" + tag.toLowerCase() + ".png");
    }
